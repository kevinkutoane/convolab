...
public class PlaceholderKnowledgeEngine : IKnowledgeEngine {
    public Task<KnowledgeBaseId> CreateKnowledgeBaseAsync(string name, string description, CancellationToken cancellationToken = default) => Task.FromResult(KnowledgeBaseId.CreateUnique());
    public Task<KnowledgeItemId> AddKnowledgeItemAsync(KnowledgeBaseId baseId, string title, string content, string source, CancellationToken cancellationToken = default) => Task.FromResult(KnowledgeItemId.CreateUnique());
