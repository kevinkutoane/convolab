...
public class PlaceholderConversationEngine : IConversationEngine {
    public Task<ConversationId> StartConversationAsync(string title, UserId initialParticipantId, CancellationToken cancellationToken = default) => Task.FromResult(ConversationId.CreateUnique());
