...
public class PlaceholderPromptEngine : IPromptEngine {
    ...
    public Task<PromptTemplateId> CreatePromptTemplateAsync(string name, string templateString, PromptType type, string version, CancellationToken cancellationToken = default) => Task.FromResult(PromptTemplateId.CreateUnique());
