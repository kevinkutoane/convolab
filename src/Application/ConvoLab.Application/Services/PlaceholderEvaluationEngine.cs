...
public class PlaceholderEvaluationEngine : IEvaluationEngine {
    public Task<EvaluationId> StartEvaluationAsync(ConversationId conversationId, CancellationToken cancellationToken = default) => Task.FromResult(EvaluationId.CreateUnique());
    ...
    public Task<EvaluationReport> GetEvaluationReportAsync(EvaluationId evaluationId, CancellationToken cancellationToken = default) => Task.FromResult(EvaluationReport.Create(ConversationId.CreateUnique()));
}
