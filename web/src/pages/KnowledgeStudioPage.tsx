...
const collectionFields: CreateResourceField[] = [
 ...
 {name:"owner",label:"Owner",placeholder:"Knowledge team"},
 {name:"description",label:"Description",type:"textarea",placeholder:"What governed knowledge belongs in this collection?"},
 {name:"classification",label:"Classification",type:"select",options:["Public","Internal","Confidential","Restricted"]},
];
...
export function KnowledgeStudioPage(){
 ...
 return <div className="page-stack knowledge-studio">
  ...
  <AdaptiveWorkspace storageKey="knowledge" leftLabel="Collections" hasRight={false}>
