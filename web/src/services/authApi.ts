...
export function getAntiforgeryRequestToken() { return antiforgeryRequestToken; }
export function clearAntiforgeryRequestToken() { antiforgeryRequestToken = undefined; }
...
export async function prepareAntiforgery(force = false) {
  ...
  try { return await antiforgeryRequestTokenPromise; }
  finally { antiforgeryRequestTokenPromise = undefined; }
}
export async function logout() { await request("/api/auth/logout",{method:"POST"}); clearAntiforgeryRequestToken(); }
